...
void test_RLE() {
    assert(strcmp(RLE(""), "") == 0);
    assert(strcmp(RLE("abc"), "1a1b1c") == 0);
    assert(strcmp(RLE("abbccc"), "1a2b3c") == 0);
    assert(strcmp(RLE("aaabaa"), "3a1b2a") == 0);
    assert(strcmp(RLE("aAa"), "1a1A1a") == 0);
    assert(strcmp(RLE("WWWWWWWWWWWWW"), "9W4W") == 0);
}
