...
| 1    | link:src/main/java/exercice/Exercice1.java[meilleur python]| python     | Simplicité
| 2    | link:src/main/java/exercice/Exercice2.java[meilleur python]    | python     | Complexite
| ...  | ...                                                      | ...      | ...      
|==========================================================================
