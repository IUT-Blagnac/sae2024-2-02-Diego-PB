...
| 1    | link:src/main/java/iut/sae/algo/simplicite-meilleur.py[meilleur python]| python     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/efficacite-meilleur.py[meilleur python]| python     | Efficatcité
| 3    | link:src/main/java/iut/sae/algo/simplicite.java[java]| java     | Simplicité
| 4    | link:src/main/java/iut/sae/algo/sobriete-meilleur.py[meilleur python]| python     | Sobriété
|==========================================================================
